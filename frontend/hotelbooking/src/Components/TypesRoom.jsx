...
const TypesRoom = () => {
    ...
    const getCategoryRoom = async () => {
        ...
        try {
            ...
            setLoader(true)
            const res = await fetch(`https://hotelbooking-zs0a.onrender.com/client/get-types-room/${roomType}`, {
                method: "GET"
            })
                            ...
                            return (
                                <div className="room-card" key={item._id} data-aos="fade-right">
                                    <div className="room-img">
                                        <img src={`https://hotelbooking-zs0a.onrender.com/${item.room_image}`} alt="room image" title='room image' />
                                    </div>
